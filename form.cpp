      ...
      m_bSignClick(false)
{
    ...
    foreach(int i, numList)
    {
        ...
        QPushButton *pBtn = this->findChild<QPushButton*>(objName);
        connect(pBtn, &QPushButton::clicked, this, &Form::onConvertClicked);
    }
...
QString Form::delete_zero(QString ret)
{
    //无效无用0
    QString str = ret;
    //删除头部无效0
...
int Form::twoToeight(QString str) //2转8
{
    if(str == "000")
        return 0;
    else if(str == "001")
...
int Form::twoTosixteen(QString str)//2转16
{
    if(str == "0000")
        return 0;
    else if(str == "0001")
...
QString Form::eightTotwo(int num)//8转2
{
    switch(num)
    {
    case 0:return "000";
...
QString Form::sixteenTotwo(int num)//16转2
{
    switch (num)
    {
    case 0:return "0000";
